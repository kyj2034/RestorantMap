...
export default{
  ...
  mounted() {
    ...
    function setUiAddress(str){
      this.setAddressAct(str.split(', ').reverse().join(' '));
    }

    async function addUiAddress() {
        console.log("addUiAddress", e.coordinate);
      ...
      this.setAddressAct(addressInfo.data.display_name.split(', ').reverse().join(' '));
    ...
    geocoder.on('addresschosen', (evt) => {
      this.setAddressAct(evt.address.details.name.split(', ').reverse().join(' '));
    })
